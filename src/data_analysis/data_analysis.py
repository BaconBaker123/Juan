...
def score_cal(dataframe):
    ...
    for i in range(dataframe.shape[0]):
        ...
        if dataframe.loc[i]['When you hear “risk” related to your finances, what is the first thought that comes to mind?'] == 'I worry I could be left with nothing.':
            ...
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 3
            ...
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 10
        ...
        if dataframe.loc[i]['What did you do when you experienced a 20% decline in the value of your investments?'] == 'sold everything.':
            ...
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 5
        ...
        if dataframe.loc[i]['When you hear “risk” related to your finances, what is the first thought that comes to mind?.1'] == 'I try to avoid making decisions.':
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 0
        elif dataframe.loc[i]['When you hear “risk” related to your finances, what is the first thought that comes to mind?.1'] == 'I reluctantly make decisions.':
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 6
        elif dataframe.loc[i]['When you hear “risk” related to your finances, what is the first thought that comes to mind?.1'] == 'I confidently make decisions and don’t look back.':
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 15
        #Qestion 7(Risk Capacity)
        if dataframe.loc[i]['How much do you want to invest to get started?'] == '$5,000 to $25,000':
            score_dict[dataframe.loc[i]['电子邮件地址']][0] += 5
        ...
        if dataframe.loc[i]['How much investment value fluctuation would you be comfortable with 1 year from now?'] == '−10% to 15%':
            ...
            score_dict[dataframe.loc[i]['电子邮件地址']][1] += 8
        ...
        if dataframe.loc[i]['How much investment value fluctuation would you be comfortable with 1 year from now?.1'] == 'Monthly Contribution / Initial Investment < 10%':
            score_dict[dataframe.loc[i]['电子邮件地址']][0] += 5
        elif dataframe.loc[i]['How much investment value fluctuation would you be comfortable with 1 year from now?.1'] == 'Monthly Contribution / Initial Investment ≥ 10%':
            score_dict[dataframe.loc[i]['电子邮件地址']][0] += 10
        ...
        if dataframe.loc[i]['How long do you need the income to last?'] == '1 to 4 years':
            ...
            score_dict[dataframe.loc[i]['电子邮件地址']][0] += 35
        ...
        if dataframe.loc[i]['How would you consider yourself?'] == 'Return strategy investor (i.e. prefer generating capital gains from stocks over fixed income from bonds)':
            score_dict[dataframe.loc[i]['电子邮件地址']].append('Return strategy investor')
            ...
            score_dict[dataframe.loc[i]['电子邮件地址']].append('Income strategy investor')
    return score_dict 
...
def random(dataframe):
    ...
    #
    for i in range(dataframe.shape[0]):
        score_dict[dataframe.loc[i]['电子邮件地址']] = [
            #Qestion 1(Risk Capacity)
            dataframe.loc[i]['What is your goal for investing?'],
            #Qestion 2(Risk Willingness)
            dataframe.loc[i]['What is your understanding of stocks, bonds, and ETFs?'],
            #Qestion 3(Risk Willingness)
            dataframe.loc[i]['When you hear “risk” related to your finances, what is the first thought that comes to mind?'],
            #Qestion 4(Risk Willingness/But Not Scored)
            dataframe.loc[i]['Have you ever experienced a 20% or more decline in the value of your investments in one year?'],
            #Qestion 5a(Risk Willingness)
            dataframe.loc[i]['What did you do when you experienced a 20% decline in the value of your investments?'],
            #Qestion 5b(Risk Willingness)
            dataframe.loc[i]['If you were ever to experience a 20% decline or more in the value of your investments in one year, what would you do?'],
            #Qestion 6(Risk Willingness)
            dataframe.loc[i]['When you hear “risk” related to your finances, what is the first thought that comes to mind?.1'],
            #Qestion 7(Risk Capacity)
            dataframe.loc[i]['How much do you want to invest to get started?'],
            #Qestion 8(Risk Willingness)
            dataframe.loc[i]['How much investment value fluctuation would you be comfortable with 1 year from now?'],
            #Qestion 9(Risk Capacity)
            dataframe.loc[i]['How much investment value fluctuation would you be comfortable with 1 year from now?.1'],
            #Qestion 10a(Risk Capacity)
            dataframe.loc[i]['How long do you need the income to last?'],
            #Qestion 10b(Risk Capacity)
            dataframe.loc[i]['When will you need to start withdrawing funds from this account?'],
            #Qestion 11(Return strategy investor/Income strategy investor)
            dataframe.loc[i]['How would you consider yourself?']
        ]
    print(score_dict)
#random(dataframe)
